...
sudo curl https://raw.githubusercontent.com/rlmax/Install-Parse-Server-on-Ubuntu/master/ubuntu-18.04/parse-dashboard-config.json > parse-dashboard-config.json
sudo curl https://raw.githubusercontent.com/rlmax/Install-Parse-Server-on-Ubuntu/master/ubuntu-18.04/dashboard-running.json > dashboard-running.json
npm -g install
echo
